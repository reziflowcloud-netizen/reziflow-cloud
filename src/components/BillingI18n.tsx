...
const billingText = {
  ru: {
    ...
    subtitle: 'План, пробный период и лимиты организации',
    back: 'Назад',
    currentPlan: 'Текущий тариф',
    softLimitsCopy: 'Просмотр и редактирование существующих данных доступны, но новые записи сверх лимита будут ограничены.',
    ...
    warningBody: 'Скоро создание новых записей может быть ограничено. Лучше заранее перейти на тариф выше или обсудить индивидуальный лимит.',
    ...
    nextStepBody: 'Если организации нужен больший объём, администратор LegalHub может изменить тариф или задать индивидуальные лимиты.',
  ...
  uk: {
    ...
    subtitle: 'План, пробний період і ліміти організації',
    back: 'Назад',
    currentPlan: 'Поточний тариф',
    softLimitsCopy: 'Перегляд і редагування наявних даних доступні, але нові записи понад ліміт будуть обмежені.',
    ...
    warningBody: 'Незабаром створення нових записів може бути обмежене. Краще заздалегідь перейти на тариф вище або обговорити індивідуальний ліміт.',
    ...
    nextStepBody: 'Якщо організації потрібен більший обсяг, адміністратор LegalHub може змінити тариф або задати індивідуальні ліміти.',
  ...
  pl: {
    ...
    subtitle: 'Plan, okres próbny i limity organizacji',
    back: 'Wstecz',
    currentPlan: 'Aktualny taryf',
    softLimitsCopy: 'Przeglądanie i edycja istniejących danych są dostępne, ale nowe rekordy ponad limit będą ograniczone.',
    ...
    warningBody: 'Tworzenie nowych rekordów może wkrótce zostać ograniczone. Warto wcześniej przejść na wyższą taryfę albo omówić indywidualny limit.',
    ...
    nextStepBody: 'Jeśli organizacja potrzebuje większego zakresu, administrator LegalHub może zmienić taryfę albo ustawić indywidualne limity.',
