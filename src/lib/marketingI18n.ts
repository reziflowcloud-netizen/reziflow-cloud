...
const ruMarketingCopy: MarketingCopy = {
  ...
  pricing: {
    kicker: 'Тарифы',
    title: 'Начните бесплатно навсегда, а тариф выберите когда вырастете',
    text: 'Free можно использовать без ограничения по времени. Платный тариф понадобится, когда вы вырастете по команде, клиентам, активным делам или лидам.',
    plans: [
      {
        id: 'free',
      ...
      },
      {
        ...
        price: '499 zł',
        period: '/ месяц',
        text: 'Основной тариф для растущего агентства с командой, потоком заявок и управленческим контролем.',
        items: [
          'До 10 пользователей',
          'До 200 клиентов',
          'До 200 активных дел',
      ...
      },
      {
        ...
        price: 'от 849 zł',
        period: '/ месяц',
        text: 'Для больших команд, нескольких офисов и индивидуальных процессов.',
        items: [
          'Индивидуальные лимиты',
          'Несколько отделов или офисов',
          'Приоритетная поддержка',
          'Помощь с миграцией базы',
          'Индивидуальные шаблоны документов',
          'Расширенные интеграции и персональный запуск',
        ],
  ...
  final: {
    ...
    note: 'Карта не нужна · Free доступен без ограничения по времени',
  },
  footer: {
...
const ukMarketingCopy: MarketingCopy = {
  ...
  pricing: {
    kicker: 'Тарифи',
    title: 'Почніть безкоштовно назавжди, а тариф виберіть, коли виростете',
    text: 'Free можна використовувати без обмеження за часом. Платний тариф знадобиться, коли команда, база клієнтів, активні справи або ліди виростуть.',
    plans: [
      {
        id: 'free',
        eyebrow: 'Free forever',
      ...
      },
      {
        ...
        price: '499 zł',
        period: '/ місяць',
        text: 'Основний тариф для агентства, що зростає, з командою, потоком заявок і управлінським контролем.',
        items: [
          'До 10 користувачів',
          'До 200 клієнтів',
          'До 200 активних справ',
          'До 300 лідів',
          'Ролі, доступи, звіти, шаблони та розширений контроль',
        ],
      ...
      },
      {
        ...
        price: 'від 849 zł',
        period: '/ місяць',
        text: 'Для великих команд, кількох офісів та індивідуальних процесів.',
        items: [
          'Індивідуальні ліміти',
          'Кілька відділів або офісів',
          'Пріоритетна підтримка',
          'Допомога з міграцією бази',
          'Індивідуальні шаблони документів',
          'Розширені інтеграції та персональний запуск',
        ],
  ...
  final: {
    ...
    note: 'Картка не потрібна · Free доступний без обмеження за часом',
  },
  footer: {
...
const enMarketingCopy: MarketingCopy = {
  ...
  pricing: {
    kicker: 'Pricing',
    title: 'Start free forever, choose a plan when you grow',
    text: 'Free can be used without a time limit. A paid plan becomes useful when your team, client base, active cases or leads grow.',
    plans: [
      {
        id: 'free',
        eyebrow: 'Free forever',
      ...
      },
      {
        ...
        price: '499 zł',
        period: '/ month',
        text: 'The main plan for a growing agency with a team, steady request flow and management control.',
        items: [
          'Up to 10 users',
          'Up to 200 clients',
          'Up to 200 active cases',
          'Up to 300 leads',
          'Roles, permissions, reports, templates and extended control',
        ],
      ...
      },
      {
        ...
        price: 'from 849 zł',
        period: '/ month',
        text: 'For large teams, several offices and individual processes.',
        items: [
          'Individual limits',
          'Several departments or offices',
          'Priority support',
          'Database migration help',
          'Individual document templates',
          'Advanced integrations and personal launch',
        ],
  ...
  final: {
    ...
    secondary: 'View demo',
    note: 'No card needed · Free has no time limit',
  },
  footer: {
...
const plMarketingCopy: MarketingCopy = {
  ...
  pricing: {
    kicker: 'Cennik',
    title: 'Zacznij bezpłatnie na stałe, a taryfę wybierz, gdy urośniesz',
    text: 'Free można używać bez limitu czasu. Płatna taryfa będzie potrzebna, gdy urośnie zespół, baza klientów, aktywne sprawy albo leady.',
    plans: [
      {
        id: 'free',
        eyebrow: 'Free forever',
      ...
      },
      {
        ...
        price: '499 zł',
        period: '/ miesiąc',
        text: 'Główna taryfa dla rozwijającej się agencji z zespołem, stałym napływem zgłoszeń i kontrolą managerską.',
        items: [
          'Do 10 użytkowników',
          'Do 200 klientów',
          'Do 200 aktywnych spraw',
          'Do 300 leadów',
          'Role, dostępy, raporty, szablony i rozszerzona kontrola',
        ],
      ...
      },
      {
        ...
        price: 'od 849 zł',
        period: '/ miesiąc',
        text: 'Dla dużych zespołów, kilku biur i indywidualnych procesów.',
        items: [
          'Indywidualne limity',
          'Kilka działów albo biur',
          'Priorytetowe wsparcie',
          'Pomoc w migracji bazy',
          'Indywidualne szablony dokumentów',
          'Rozszerzone integracje i osobisty start',
        ],
  ...
  final: {
    ...
    note: 'Karta nie jest potrzebna · Free dostępny bez limitu czasu',
  },
  footer: {
