...
const ruMarketingCopy: MarketingCopy = {
  ...
  hero: {
    ...
    title: 'LegalHub — CRM для компаний по легализации в Польше, где каждый клиент, документ, срок и сотрудник под контролем',
    lead: 'Заявки из сайта, Instagram, Facebook, Telegram и WhatsApp попадают в одну систему. По каждому клиенту видно: услуга, статус, ответственный, документы, дедлайн, оплата и следующий шаг.',
    primary: 'Посмотреть демо на примере дела',
  ...
  productTour: {
    ...
    title: 'Посмотрите LegalHub на примере реального дела',
    text: 'От первой заявки до завершенного процесса: источник лида, услуга, ответственный, документы, дедлайн, оплата и следующий шаг видны в одной системе.',
    previewAriaPrefix: 'Экран LegalHub',
    modules: [
      {
        id: 'leads',
        label: 'Заявки',
        title: 'Новые заявки сразу попадают в работу',
        text: 'Источник, интерес, язык, контакт, ответственный и следующий шаг видны в одной карточке. Менеджеру не нужно вручную собирать информацию из чатов.',
      ...
      },
      {
        id: 'cases',
        label: 'Дела',
        title: 'Каждое дело имеет этап, дедлайн и ответственного',
        text: 'Клиента можно вести по понятным этапам: консультация, сбор документов, готово к подаче, подано, ожидание решения, завершено.',
      ...
      },
      {
        id: 'documents',
        label: 'Документы',
        title: 'Сразу видно, чего не хватает',
        text: 'По каждому делу видно, какие документы получены, какие отсутствуют и что нужно запросить у клиента.',
      ...
      },
      {
        id: 'control',
        label: 'Контроль',
        title: 'Руководитель видит просрочки и нагрузку',
        text: 'Владелец компании видит, какие дела стоят без движения, кто отвечает за клиента и где есть риск просрочки.',
  ...
  pricing: {
    kicker: 'Тарифы',
    title: 'Начните бесплатно, а тариф выберите после теста на реальных делах',
    text: 'Создайте рабочее пространство, добавьте несколько клиентов или импортируйте таблицу. Когда команда увидит пользу в работе, выберите подходящий тариф.',
    plans: [
      {
        id: 'free',
  ...
  final: {
    ...
    title: 'Запустите первый процесс легализации в LegalHub уже сегодня',
    text: 'Добавьте несколько заявок или импортируйте таблицу и проверьте CRM на реальном процессе: клиенты, документы, дедлайны, оплаты и ответственные в одной системе.',
    primary: 'Начать бесплатно',
    secondary: 'Посмотреть демо',
    note: 'Старт за несколько минут · Без карты · Можно начать с 5–10 клиентов',
  },
  footer: {
